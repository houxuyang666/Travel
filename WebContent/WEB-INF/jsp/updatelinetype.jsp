...
body {
	background: url('images/105.jpg') no-repeat 0 0 transparent;
...
<h1>类型修改</h1>
	<div id="box">
		<form:form action="updatelinetype.action" method="post" enctype="multipart/form-data" modelAttribute="linetype">
		<div >
			<input type="hidden" value="${linetype.linetypeid}" name="linetypeid" >
			线路类型名称:<input type="text" value="${linetype.typename}" name="typename"><br>
		          线路类型图标:<img src="upload/${linetype.icon}"><br><br>
			更换类型图标: <input type="file" name="file"><br>
			<input type="submit" value="修改线路类型信息" class="btn"><br>
			</div>
